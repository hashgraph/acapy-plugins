...
from hedera_did.did import HederaDIDRegistrar
...
class TestHederaDIDRegistrar(IsolatedAsyncioTestCase):
            ...
            settings={
                ...
                "plugin_config": {
                    "hedera_did": {
                        "network": "testnet",
                        "operator_id": "0.0.1",
                        "operator_key_der": "31ACDD47830239324BA37D493F959A1585774DBC04DA0679C162B95151F6593C",
                    }
                },
            }
        )
    ...
    @patch("hedera_did.did.registrar.HederaDid")
